    ...
    init: function () {
      var canvas = document.getElementById("chart"),
        ...
        data = {
          ...
          parts: {"pt": [statistics.passed, statistics.failed,statistics.pending]},//percentage of each parts
          colors: {"cs": ['#4CAF50', "#FF5252","#c99404"]}//color of each part
        },
        self = this,
        chart;
      ...
      canvas.onmousemove = function (e) {
        ...
        var statistics = self.getStatistics(),
            ...
            pendingRound = Math.round(pending) + "%";
        ...
        else if(hex.toLowerCase() === data.colors.cs[2].toLowerCase()) {
          chartCtx.fillText(pendingRound, a, b);
        }
        else {
    ...
    getStatistics:function () {
      var scenarioPassed = document.querySelectorAll('.scenario.passed').length,
        scenarioFailed = document.querySelectorAll('.scenario.failed').length,
          scenarioPending = document.querySelectorAll('.scenario.pending').length,
        ...
        pending = (scenarioPending / scenariosAmount) * 100,
        statistics;
